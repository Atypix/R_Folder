...
history <- model %>% fit(y = list(y_train_date, y_train_boule1, y_train_boule2, y_train_boule3, y_train_boule4, y_train_boule5, y_train_star1, y_train_star2),
                         ...
                         verbose = 1,
                         validation_data= list(list(X_validation_date, X_validation_boule1, X_validation_boule2, X_validation_boule3, X_validation_boule4, X_validation_boule5, X_validation_star1, X_validation_star2),list(y_validation_date, y_validation_boule1, y_validation_boule2, y_validation_boule3, y_validation_boule4, y_validation_boule5, y_validation_star1, y_validation_star2)),
                         shuffle=FALSE
)
