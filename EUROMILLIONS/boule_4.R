...
boule = as.data.frame(df$boule_4)
names(boule)[names(boule) == "boule_4"] <- "boule"
...
model <- load_model_hdf5('boule_4.h5', custom_objects = NULL, compile = TRUE)
