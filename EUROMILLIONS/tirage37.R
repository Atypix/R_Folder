...
test <- datas[(nrow(datas)-80):nrow(datas),] 
...
message(">> Training")
model <- load_model_hdf5('tirage37.h5')
...
#pred_test <- model %>% predict(list(y_train_date, y_train_boule1, y_train_boule2, y_train_boule3, y_train_boule4, y_train_boule5, y_train_star1, y_train_star2), verbose = 1, batch_size=10)


#pred_test <- predict(model, list(X_test_date,X_test_boule1, X_test_boule2, X_test_boule3, X_test_boule4, X_test_boule5, X_test_star1, X_test_star2))
pred_test <- model %>% predict(list(X_train_date, X_train_boule1, X_train_boule2, X_train_boule3, X_train_boule4, X_train_boule5, X_train_star1, X_train_star2), verbose = 1, batch_size=10)
