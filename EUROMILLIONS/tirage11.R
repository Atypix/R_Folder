...
test <- datas[(nrow(datas)-50):nrow(datas),] 
...
X_train_date <- train_matrix_date[, (n_timesteps):(n_timesteps * 2)]
y_train_date <- train_matrix_date[, 1:(n_timesteps)]
X_test_date <- test_matrix_date[, (n_timesteps):(n_timesteps * 2)]
...
X_train_boule2 <- train_matrix_boule2[, (n_timesteps):(n_timesteps  * 2)]
y_train_boule2 <- train_matrix_boule2[, 1:(n_timesteps + 1)]
X_test_boule2 <- train_matrix_boule2_test[, (n_timesteps):(n_timesteps  * 2)]
y_test_boule2 <- train_matrix_boule2_test[, 1:(n_timesteps + 1)]
...
X_train_boule3 <- train_matrix_boule3[, (n_timesteps):(n_timesteps * 2)]
y_train_boule3 <- train_matrix_boule3[, 1:(n_timesteps + 1)]
X_test_boule3 <- train_matrix_boule3_test[, (n_timesteps):(n_timesteps * 2)]
y_test_boule3 <- train_matrix_boule3_test[, 1:(n_timesteps + 1)]
...
X_train_boule4 <- train_matrix_boule4[, (n_timesteps):(n_timesteps  * 2)]
y_train_boule4 <- train_matrix_boule4[, 1:(n_timesteps + 1)]
X_test_boule4 <- train_matrix_boule4_test[, (n_timesteps):(n_timesteps  * 2)]
y_test_boule4 <- train_matrix_boule4_test[, 1:(n_timesteps + 1)]
...
X_train_boule5 <- train_matrix_boule5[, (n_timesteps):(n_timesteps  * 2)]
y_train_boule5 <- train_matrix_boule5[, 1:(n_timesteps + 1)]
X_test_boule5 <- train_matrix_boule5_test[, (n_timesteps):(n_timesteps  * 2)]
y_test_boule5 <- train_matrix_boule5_test[, 1:(n_timesteps + 1)]
...
X_train_star1 <- train_matrix_star1[, (n_timesteps):(n_timesteps  * 2)]
y_train_star1 <- train_matrix_star1[, 1:(n_timesteps + 1)]
X_test_star1 <- train_matrix_star1_test[, (n_timesteps):(n_timesteps   * 2)]
y_test_star1 <- train_matrix_star1_test[, 1:(n_timesteps + 1)]
...
X_train_star2 <- train_matrix_star2[, (n_timesteps):(n_timesteps * 2)]
y_train_star2 <- train_matrix_star2[, 1:(n_timesteps + 1)]
X_test_star2 <- train_matrix_star2_test[, (n_timesteps):(n_timesteps * 2)]
y_test_star2 <- train_matrix_star2_test[, 1:(n_timesteps + 1)]
...
model %>%
  layer_lstm (units = 100, input_shape= c(n_timesteps, n_features), name='lstm_0_boule1') %>% 
...
history <- model %>% fit(x = X_train_boule1,
                         y = y_train_boule1,
                         epochs = epochs,
...
pred_test <- model %>% predict (X_test_boule1, batch_size = batch_size) 

prediction <- reverse_scaling(as.data.frame(pred_test), ScaledBoule$scaler)
