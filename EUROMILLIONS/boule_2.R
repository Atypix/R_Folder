...
boule = as.data.frame(df$boule_2)
names(boule)[names(boule) == "boule_2"] <- "boule"
...
model <- load_model_hdf5('boule_2.h5', custom_objects = NULL, compile = TRUE)
