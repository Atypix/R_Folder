...
datas <- df
n_ <- round(nrow(datas) * .97, digits = 0)
train <- datas[1:n_, ] 
...
# )
# 
# combined_boule1 <- layer_concatenate(c(outputLSTM_boule1, outputLSTM_boule2), name='concatenate_boule1') %>%
...
# 
# combined_boule2 <- layer_concatenate(c(outputLSTM_boule2, outputLSTM_boule3), name='concatenate_boule2') %>%
...
# 
# combined_boule3 <- layer_concatenate(c(outputLSTM_boule3, outputLSTM_boule4), name='concatenate_boule3') %>%
...
# 
# combined_boule4 <- layer_concatenate(c(outputLSTM_boule4, outputLSTM_boule5), name='concatenate_boule4') %>%
...
# 
# combined_boule5 <- layer_concatenate(c(outputLSTM_boule5, outputLSTM_boule1), name='concatenate_boule5') %>%
...
write_xlsx(view_test, paste0(getwd(),'/tirage21.xlsx'))
