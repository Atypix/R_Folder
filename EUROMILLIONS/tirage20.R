...
#   
#   t(sapply(1:(length(tseries)), function(x)
#     tseries[(x  + 1):(x  + overall_timesteps*2 -1)]))
#   
# }
...
y_train_date <- train_matrix_date[, (n_timesteps+1):(n_timesteps  + n_predictions)]
X_test_date <- test_matrix_date[, 1:n_timesteps]
y_test_date <- test_matrix_date[, (n_timesteps + 1):(n_timesteps  + n_predictions)]

# X_train_date <- X_train_date[1:(nrow(X_train_date) %/% batch_size * batch_size),]
# y_train_date <- X_train_date[1:(nrow(y_train_date) %/% batch_size * batch_size),]
# X_test_date <- X_test_date[1:(nrow(X_test_date) %/% batch_size * batch_size),]
# y_test_date <- X_test_date[1:(nrow(y_test_date) %/% batch_size * batch_size),]

X_train_boule1 <- train_matrix_boule1[, 1:n_timesteps]
y_train_boule1 <- train_matrix_boule1[, (n_timesteps + 1):(n_timesteps  + n_predictions)]
X_test_boule1 <- train_matrix_boule1_test[, 1:n_timesteps]
y_test_boule1 <- train_matrix_boule1_test[, (n_timesteps + 1):(n_timesteps  + n_predictions)]

# X_train_boule1 <- X_train_boule1[1:(nrow(X_train_boule1) %/% batch_size * batch_size),]
# y_train_boule1 <- X_train_boule1[1:(nrow(y_train_boule1) %/% batch_size * batch_size),]
# X_test_boule1 <- X_test_boule1[1:(nrow(X_test_boule1) %/% batch_size * batch_size),]
# y_test_boule1 <- X_test_boule1[1:(nrow(y_test_boule1) %/% batch_size * batch_size),]

X_train_boule2 <- train_matrix_boule2[, 1:n_timesteps]
y_train_boule2 <- train_matrix_boule2[, (n_timesteps + 1):(n_timesteps  + n_predictions)]
X_test_boule2 <- train_matrix_boule2_test[, 1:n_timesteps]
y_test_boule2 <- train_matrix_boule2_test[, (n_timesteps + 1):(n_timesteps  + n_predictions)]

# X_train_boule2 <- X_train_boule2[1:(nrow(X_train_boule2) %/% batch_size * batch_size),]
# y_train_boule2 <- X_train_boule2[1:(nrow(y_train_boule2) %/% batch_size * batch_size),]
# X_test_boule2 <- X_test_boule2[1:(nrow(X_test_boule2) %/% batch_size * batch_size),]
# y_test_boule2 <- X_test_boule2[1:(nrow(y_test_boule2) %/% batch_size * batch_size),]

X_train_boule3 <- train_matrix_boule3[, 1:n_timesteps]
y_train_boule3 <- train_matrix_boule3[, (n_timesteps + 1):(n_timesteps  + n_predictions)]
X_test_boule3 <- train_matrix_boule3_test[, 1:n_timesteps]
y_test_boule3 <- train_matrix_boule3_test[, (n_timesteps + 1):(n_timesteps  + n_predictions)]

# X_train_boule3 <- X_train_boule3[1:(nrow(X_train_boule3) %/% batch_size * batch_size),]
# y_train_boule3 <- X_train_boule3[1:(nrow(y_train_boule3) %/% batch_size * batch_size),]
# X_test_boule3 <- X_test_boule3[1:(nrow(X_test_boule3) %/% batch_size * batch_size),]
# y_test_boule3 <- X_test_boule3[1:(nrow(y_test_boule3) %/% batch_size * batch_size),]

X_train_boule4 <- train_matrix_boule4[, 1:n_timesteps]
y_train_boule4 <- train_matrix_boule4[, (n_timesteps + 1):(n_timesteps  + n_predictions)]
X_test_boule4 <- train_matrix_boule4_test[, 1:n_timesteps]
y_test_boule4 <- train_matrix_boule4_test[, (n_timesteps + 1):(n_timesteps  + n_predictions)]

# X_train_boule4 <- X_train_boule4[1:(nrow(X_train_boule4) %/% batch_size * batch_size),]
# y_train_boule4 <- X_train_boule4[1:(nrow(y_train_boule4) %/% batch_size * batch_size),]
# X_test_boule4 <- X_test_boule4[1:(nrow(X_test_boule4) %/% batch_size * batch_size),]
# y_test_boule4 <- X_test_boule4[1:(nrow(y_test_boule4) %/% batch_size * batch_size),]

X_train_boule5 <- train_matrix_boule5[, 1:n_timesteps]
y_train_boule5 <- train_matrix_boule5[, (n_timesteps + 1):(n_timesteps  + n_predictions)]
X_test_boule5 <- train_matrix_boule5_test[, 1:n_timesteps]
y_test_boule5 <- train_matrix_boule5_test[, (n_timesteps + 1):(n_timesteps  + n_predictions)]

# X_train_boule5 <- X_train_boule5[1:(nrow(X_train_boule5) %/% batch_size * batch_size),]
# y_train_boule5 <- X_train_boule5[1:(nrow(y_train_boule5) %/% batch_size * batch_size),]
# X_test_boule5 <- X_test_boule5[1:(nrow(X_test_boule5) %/% batch_size * batch_size),]
# y_test_boule5 <- X_test_boule5[1:(nrow(y_test_boule5) %/% batch_size * batch_size),]

X_train_star1 <- train_matrix_star1[, 1:n_timesteps]
y_train_star1 <- train_matrix_star1[, (n_timesteps + 1):(n_timesteps  + n_predictions)]
X_test_star1 <- train_matrix_star1_test[, 1:n_timesteps]
y_test_star1 <- train_matrix_star1_test[, (n_timesteps + 1):(n_timesteps  + n_predictions)]

# X_train_star1 <- X_train_star1[1:(nrow(X_train_star1) %/% batch_size * batch_size),]
# y_train_star1 <- X_train_star1[1:(nrow(y_train_star1) %/% batch_size * batch_size),]
# X_test_star1 <- X_test_star1[1:(nrow(X_test_star1) %/% batch_size * batch_size),]
# y_test_star1 <- X_test_star1[1:(nrow(y_test_star1) %/% batch_size * batch_size),]

X_train_star2 <- train_matrix_star2[, 1:n_timesteps]
y_train_star2 <- train_matrix_star2[, (n_timesteps + 1):(n_timesteps  + n_predictions)]
X_test_star2 <- train_matrix_star2_test[, 1:n_timesteps]
y_test_star2 <- train_matrix_star2_test[, (n_timesteps + 1):(n_timesteps  + n_predictions)]

# X_train_star2 <- X_train_star2[1:(nrow(X_train_star2) %/% batch_size * batch_size),]
# y_train_star2 <- X_train_star2[1:(nrow(y_train_star2) %/% batch_size * batch_size),]
# X_test_star2 <- X_test_star2[1:(nrow(X_test_star2) %/% batch_size * batch_size),]
# y_test_star2 <- X_test_star2[1:(nrow(y_test_star2) %/% batch_size * batch_size),]
...
outputLSTM_boule1 <- inputsLSTM_boule1  %>%
  layer_lstm (units = 100, name='lstm_0_boule1', input_shape = c(n_timesteps, n_features), return_sequences=TRUE) %>% 
  layer_dropout(rate = 0.8, name='lstm_dropout_0_boule1') %>% 
  #layer_dense(25, activation='sigmoid', name='dense_pooling_boule1') %>%
  layer_dense(1, name='dense_out_boule1', activation='linear')
...
outputLSTM_boule2 <- inputsLSTM_boule2  %>%
  layer_lstm (units = 100, name='lstm_0_boule2', input_shape = c(n_timesteps, n_features), return_sequences=TRUE) %>% 
  layer_dropout(rate = 0.8, name='lstm_dropout_0_boule2') %>% 
  #layer_dense(25, activation='sigmoid', name='dense_pooling_boule2') %>%
  layer_dense(1, name='dense_out_boule2', activation='linear')
...
outputLSTM_boule3 <- inputsLSTM_boule3  %>%
  layer_lstm (units = 100, name='lstm_0_boule3', input_shape = c(n_timesteps, n_features), return_sequences=TRUE) %>% 
  layer_dropout(rate = 0.8, name='lstm_dropout_0_boule3') %>% 
  #layer_dense(25, activation='sigmoid', name='dense_pooling_boule3') %>%
  layer_dense(1, name='dense_out_boule3', activation='linear')
...
outputLSTM_boule4 <- inputsLSTM_boule4  %>%
  layer_lstm (units = 100, name='lstm_0_boule4',  input_shape = c(n_timesteps, n_features), return_sequences=TRUE) %>% 
  layer_dropout(rate = 0.8, name='lstm_dropout_0_boule4') %>% 
  #layer_dense(25, activation='sigmoid', name='dense_pooling_boule4') %>%
  layer_dense(1, name='dense_out_boule4', activation='linear')
...
outputLSTM_boule5 <- inputsLSTM_boule5  %>%
  layer_lstm (units = 100, name='lstm_0_boule5',  input_shape = c(n_timesteps, n_features), return_sequences=TRUE) %>% 
  layer_dropout(rate = 0.8, name='lstm_dropout_0_boule5') %>% 
  #layer_dense(25, activation='sigmoid', name='dense_pooling_boule5') %>%
  layer_dense(1, name='dense_out_boule5', activation='linear')
...
outputLSTM_star1 <- inputsLSTM_star1  %>%
  layer_lstm (units = 100, name='lstm_0_star1',  input_shape = c(n_timesteps, n_features), return_sequences=TRUE) %>% 
  layer_dropout(rate = 0.8, name='lstm_dropout_0_star1') %>% 
  #layer_dense(25, activation='sigmoid', name='dense_pooling_star1') %>%
  layer_dense(1, name='dense_out_star1', activation='linear')
...
outputLSTM_star2 <- inputsLSTM_star2  %>%
  layer_lstm (units = 100, name='lstm_0_star2', input_shape = c(n_timesteps, n_features), return_sequences=TRUE) %>% 
  layer_dropout(rate = 0.8, name='lstm_dropout_0_star2')  %>% 
  #layer_dense(25, activation='sigmoid', name='dense_pooling_star2') %>%
  layer_dense(1, name='dense_out_star2', activation='linear')
...
inputs_date <- layer_input (shape = c(dim(X_train_date)[2]), name='date_input') 

output_date  <- inputs_date %>%
  #layer_dense(units = 50, name='close_dense_0', activation='linear') %>% 
  #layer_activation(activation = 'linear', name='close_relu_0') %>% 
...
combined_boule1 <- layer_concatenate(c(outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5, outputLSTM_star1, outputLSTM_star2), name='concatenate_boule1') %>%
  layer_dropout(rate = 0.8, name='combine_dropout_0_boule_1') %>%
  layer_dense(units = 100, name='combined_dense_boule1', activation='linear') %>%
  layer_activation( activation = 'sigmoid',  name='sigmoid_boule1') %>% 
  layer_dense(units = 1, name='dense_1_boule1', activation="linear")

combined_boule2 <- layer_concatenate(c(outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5, outputLSTM_star1, outputLSTM_star2, outputLSTM_boule1), name='concatenate_boule2') %>%
  layer_dropout(rate = 0.8, name='combine_dropout_0_boule_2') %>%
  layer_dense(units = 100, name='combined_dense_boule2', activation='linear') %>%
  layer_activation( activation = 'sigmoid',  name='sigmoid_boule2') %>% 
  layer_dense(units = 1, name='dense_1_boule2', activation="linear")

combined_boule3 <- layer_concatenate(c(outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5, outputLSTM_star1, outputLSTM_star2, outputLSTM_boule1, outputLSTM_boule2), name='concatenate_boule3') %>%
  layer_dropout(rate = 0.8, name='combine_dropout_0_boule_3') %>%
  layer_dense(units = 100, name='combined_dense_boule3', activation='linear') %>%
  layer_activation( activation = 'sigmoid',  name='sigmoid_boule3') %>% 
  layer_dense(units = 1, name='dense_1_boule3', activation="linear")

combined_boule4 <- layer_concatenate(c(outputLSTM_boule4, outputLSTM_boule5, outputLSTM_star1, outputLSTM_star2, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3), name='concatenate_boule4') %>%
  layer_dropout(rate = 0.8, name='combine_dropout_0_boule_4') %>%
  layer_dense(units = 100, name='combined_dense_boule4', activation='linear') %>%
  layer_activation( activation = 'sigmoid',  name='sigmoid_boule4') %>% 
  layer_dense(units = 1, name='dense_1_boule4', activation="linear")

combined_boule5 <- layer_concatenate(c(outputLSTM_boule5, outputLSTM_star1, outputLSTM_star2, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4), name='concatenate_boule5') %>%
  layer_dropout(rate = 0.8, name='combine_dropout_0_boule_5') %>%
  layer_dense(units = 100, name='combined_dense__boule5', activation='linear') %>%
  layer_activation( activation = 'sigmoid',  name='sigmoid_boule5') %>% 
  layer_dense(units = 1, name='dense_1_boule5', activation="linear")

combined_star1 <- layer_concatenate(c(outputLSTM_star1, outputLSTM_star2, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5), name='concatenate_star1') %>%
  layer_dropout(rate = 0.8, name='combine_dropout_0_star_1') %>%
  layer_dense(units = 100, name='combined_dense_star1', activation='linear') %>%
  layer_activation( activation = 'sigmoid',  name='sigmoid__star1') %>% 
  layer_dense(units = 1, name='dense_1_star1', activation="linear")

combined_star2 <- layer_concatenate(c(outputLSTM_star2, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5, outputLSTM_star1), name='concatenate_star2') %>%
  layer_dropout(rate = 0.8, name='combine_dropout_0_star_2') %>%
  layer_dense(units = 100, name='combined_dense__star2', activation='linear') %>%
  layer_activation( activation = 'sigmoid',  name='sigmoid__star2') %>% 
  layer_dense(units = 1, name='dense_1_star2', activation="linear")
...
history <- model %>% fit(x = list(X_train_date, X_train_boule1, X_train_boule2, X_train_boule3, X_train_boule4, X_train_boule5, X_train_star1, X_train_star2),
                         y = list(y_train_date, y_train_boule1, y_train_boule2, y_train_boule3, y_train_boule4, y_train_boule5, y_train_star1, y_train_star2),
                         epochs = epochs,
...
# for (i in 1:epochs) {
#   model %>% fit(x = list(X_train_date, X_train_boule1, X_train_boule2, X_train_boule3, X_train_boule4, X_train_boule5, X_train_star1, X_train_star2),
#                 y = list(y_train_date, y_train_boule1, y_train_boule2, y_train_boule3, y_train_boule4, y_train_boule5, y_train_star1, y_train_star2),
#                 epochs = 1,
#                 batch_size=batch_size,
#                 shuffle=FALSE)
...
# eval <- model %>% evaluate(list(y_test_date, y_test_boule1, y_test_boule2, y_test_boule3, y_test_boule4, y_test_boule5, y_test_star1, y_test_star2), list(y_test_date, y_test_boule1, y_test_boule2, y_test_boule3, y_test_boule4, y_test_boule5, y_test_star1, y_test_star2),verbose = 0)
# message(eval)
...
pred_test <- model %>% predict(list(y_test_date, y_test_boule1, y_test_boule2, y_test_boule3, y_test_boule4, y_test_boule5, y_test_star1, y_test_star2), verbose = 1, batch_size=batch_size)
...
names(view_test)[2] <- 'boule_1_test'
names(view_test)[3] <- 'boule_2_test'
names(view_test)[4] <- 'boule_3_test'
names(view_test)[5] <- 'boule_4_test'
names(view_test)[6] <- 'boule_5_test'
names(view_test)[7] <- 'etoile_1_test'
names(view_test)[8] <- 'etoile_2_test'

view_test$date <- sapply(view_test$date, function(x) format(as.Date(as.numeric(as.character(x)), origin="1970-01-01"), "%Y-%m-%d"))

write_xlsx(view_test, paste0(getwd(),'/tirage13.xlsx'))
