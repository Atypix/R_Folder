...
boule = as.data.frame(df$etoile_1)
names(boule)[names(boule) == "etoile_1"] <- "boule"
...
model <- load_model_hdf5('boule_6.h5', custom_objects = NULL, compile = TRUE)
...
names(pred)[1]<-paste("df$etoile_1")
