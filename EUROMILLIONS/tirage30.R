...
test <- datas[(nrow(datas)-25):nrow(datas),] 
...
X_train_date <- train_matrix_date[, (n_timesteps + 1):(n_timesteps * 2)]
y_train_date <- train_matrix_date[, 1:n_timesteps]
X_test_date <- test_matrix_date[, (n_timesteps + 1):(n_timesteps * 2)]
y_test_date <- test_matrix_date[, 1:n_timesteps]
...
X_train_boule1 <- train_matrix_boule1[, (n_timesteps + 1):(n_timesteps * 2)]
y_train_boule1 <- train_matrix_boule1[, 1:n_timesteps]
X_test_boule1 <- train_matrix_boule1_test[, (n_timesteps + 1):(n_timesteps * 2)]
y_test_boule1 <- train_matrix_boule1_test[, 1:n_timesteps]
...
X_train_boule2 <- train_matrix_boule2[, (n_timesteps + 1):(n_timesteps  * 2)]
y_train_boule2 <- train_matrix_boule2[, 1:n_timesteps]
X_test_boule2 <- train_matrix_boule2_test[, (n_timesteps + 1):(n_timesteps  * 2)]
y_test_boule2 <- train_matrix_boule2_test[, 1:n_timesteps]
...
X_train_boule3 <- train_matrix_boule3[, (n_timesteps + 1):(n_timesteps * 2)]
y_train_boule3 <- train_matrix_boule3[, 1:n_timesteps]
X_test_boule3 <- train_matrix_boule3_test[, (n_timesteps + 1):(n_timesteps * 2)]
y_test_boule3 <- train_matrix_boule3_test[, 1:n_timesteps]
...
X_train_boule4 <- train_matrix_boule4[, (n_timesteps + 1):(n_timesteps  * 2)]
y_train_boule4 <- train_matrix_boule4[, 1:n_timesteps]
X_test_boule4 <- train_matrix_boule4_test[, (n_timesteps + 1):(n_timesteps  * 2)]
y_test_boule4 <- train_matrix_boule4_test[, 1:n_timesteps]
...
X_train_boule5 <- train_matrix_boule5[, (n_timesteps + 1):(n_timesteps  * 2)]
y_train_boule5 <- train_matrix_boule5[, 1:n_timesteps]
X_test_boule5 <- train_matrix_boule5_test[, (n_timesteps + 1):(n_timesteps  * 2)]
y_test_boule5 <- train_matrix_boule5_test[, 1:n_timesteps]
...
X_train_star1 <- train_matrix_star1[, (n_timesteps + 1):(n_timesteps  * 2)]
y_train_star1 <- train_matrix_star1[, 1:n_timesteps]
X_test_star1 <- train_matrix_star1_test[, (n_timesteps + 1):(n_timesteps   * 2)]
y_test_star1 <- train_matrix_star1_test[, 1:n_timesteps]
...
X_train_star2 <- train_matrix_star2[, (n_timesteps + 1):(n_timesteps * 2)]
y_train_star2 <- train_matrix_star2[, 1:n_timesteps]
X_test_star2 <- train_matrix_star2_test[, (n_timesteps + 1):(n_timesteps * 2)]
y_test_star2 <- train_matrix_star2_test[, 1:n_timesteps]
...
outputLSTM_boule1 <- inputsLSTM_boule1  %>%
  layer_simple_rnn (units = 100, name='lstm_0_boule1') %>% 
...
outputLSTM_boule2 <- inputsLSTM_boule2  %>%
  layer_simple_rnn (units = 100, name='lstm_0_boule2') %>% 
...
outputLSTM_boule3 <- inputsLSTM_boule3  %>%
  layer_simple_rnn (units = 100, name='lstm_0_boule3') %>% 
...
outputLSTM_boule4 <- inputsLSTM_boule4  %>%
  layer_simple_rnn (units = 100, name='lstm_0_boule4') %>% 
...
outputLSTM_boule5 <- inputsLSTM_boule5  %>%
  layer_simple_rnn (units = 100, name='lstm_0_boule5') %>% 
...
outputLSTM_star1 <- inputsLSTM_star1  %>%
  layer_simple_rnn (units = 100, name='lstm_0_star1') %>% 
...
outputLSTM_star2 <- inputsLSTM_star2  %>%
  layer_simple_rnn (units = 100, name='lstm_0_star2') %>% 
...
output_date  <- inputs_date %>%
  layer_simple_rnn (units = 100, name='lstm_0_date') %>% 
...
history <- model %>% fit(x = list(y_train_date, y_train_boule1, y_train_boule2, y_train_boule3, y_train_boule4, y_train_boule5, y_train_star1, y_train_star2),
                         y = list(X_train_date, X_train_boule1, X_train_boule2, X_train_boule3, X_train_boule4, X_train_boule5, X_train_star1, X_train_star2),
                         epochs = epochs,
...
#pred_model <- model %>% predict(list(c(18408), c(9,18,43), c(4,22,32), c(27,32,37), c(14,3,25), c(21,27,5), c(4,2,6), c(6,7,7)), verbose = 1, batch_size=batch_size)

# date_input <- c(18408)
# dim(date_input) <- c(2, 1)
# boule_1_input <- c(9)
# dim(boule_1_input) <- c(2, 1)
# boule_2_input <- c(4)
# dim(boule_2_input) <- c(2, 1)
# boule_3_input <- c(27)
# dim(boule_3_input) <- c(2, 1)
# boule_4_input <- c(14)
# dim(boule_4_input) <- c(2, 1)
# boule_5_input <- c(21)
# dim(boule_5_input) <- c(2, 1)
# star_1_input <-  c(4)
# dim(star_1_input) <- c(2, 1)
# star_2_input <- c(6)
# dim(star_2_input) <- c(2, 1)
# 
# pred_model <- model %>% predict(list(date_input, boule_1_input, boule_2_input, boule_3_input, boule_4_input, boule_5_input, star_1_input, star_2_input), verbose = 1, batch_size=batch_size)
...
view_test$boule_1_test <- sapply(view_test$boule_1_test, function(x) round(x))
view_test$boule_2_test <- sapply(view_test$boule_2_test, function(x) round(x))
view_test$boule_3_test <- sapply(view_test$boule_3_test, function(x) round(x))
view_test$boule_4_test <- sapply(view_test$boule_4_test, function(x) round(x))
view_test$boule_5_test <- sapply(view_test$boule_5_test, function(x) round(x))
view_test$etoile_1_test <- sapply(view_test$etoile_1_test, function(x) round(x))
view_test$etoile_2_test <- sapply(view_test$etoile_2_test, function(x) round(x))
...
pred_model <- model$output

date_predict <- unlist(reverse_scaling(as.data.frame(pred_model[1]), ScaledDate$scaler))
boule1 <- unlist(reverse_scaling(as.data.frame(pred_model[2]), ScaledBoule$scaler))
boule2 <- unlist(reverse_scaling(as.data.frame(pred_model[3]), ScaledBoule$scaler))
boule3 <- unlist(reverse_scaling(as.data.frame(pred_model[4]), ScaledBoule$scaler))
boule4 <- unlist(reverse_scaling(as.data.frame(pred_model[5]), ScaledBoule$scaler))
boule5 <- unlist(reverse_scaling(as.data.frame(pred_model[6]), ScaledBoule$scaler))
star1 <- unlist(reverse_scaling(as.data.frame(pred_model[7]), ScaledStar$scaler))
star2 <- unlist(reverse_scaling(as.data.frame(pred_model[8]), ScaledStar$scaler))

view_model <- cbind(date_predict, boule1)
view_model <- cbind(view_model, boule2)
view_model <- cbind(view_model, boule3)
view_model <- cbind(view_model, boule4)
view_model <- cbind(view_model, boule5)
view_model <- cbind(view_model, star1)
view_model <- cbind(view_model, star2)

View(view_model)

view_model <- as.data.frame(view_model)
names(view_model)[1] <- 'date'
names(view_model)[2] <- 'boule_1_test'
names(view_model)[3] <- 'boule_2_test'
names(view_model)[4] <- 'boule_3_test'
names(view_model)[5] <- 'boule_4_test'
names(view_model)[6] <- 'boule_5_test'
names(view_model)[7] <- 'etoile_1_test'
names(view_model)[8] <- 'etoile_2_test'

view_model$date <- sapply(view_model$date, function(x) round(x))
view_model$boule_1_test <- sapply(view_model$boule_1_test, function(x) round(x))
view_model$boule_2_test <- sapply(view_model$boule_2_test, function(x) round(x))
view_model$boule_3_test <- sapply(view_model$boule_3_test, function(x) round(x))
view_model$boule_4_test <- sapply(view_model$boule_4_test, function(x) round(x))
view_model$boule_5_test <- sapply(view_model$boule_5_test, function(x) round(x))
view_model$etoile_1_test <- sapply(view_model$etoile_1_test, function(x) round(x))
view_model$etoile_2_test <- sapply(view_model$etoile_2_test, function(x) round(x))

view_model$date <- sapply(view_model$date, function(x) format(as.Date(as.numeric(as.character(x)), origin="1970-01-01"), "%Y-%m-%d"))
df$date <- sapply(df$date, function(x) format(as.Date(x, origin="1970-01-01"), "%Y-%m-%d"))

dplr <- left_join(df, view_model, by=c("date"))
