...
boule = as.data.frame(df$boule_5)
names(boule)[names(boule) == "boule_5"] <- "boule"
...
model <- load_model_hdf5('boule_5.h5', custom_objects = NULL, compile = TRUE)
