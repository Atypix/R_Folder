...
scale_boules <- function(boule1, boule2, boule3, boule4, star1, boule1_test, boule2_test, boule3_test, boule4_test, star1_test, feature_range = c(0,1)) {
  x = boule1
  ...
  return( list(scaled_boule1 = as.vector(scaled_boule1), 
               ...
               scaled_star1 = as.vector(scaled_star1),
...
x_train_star1 <- ScaledBoule$scaled_star1[,1]
...
x_train_star1_test <- ScaledBoule$scaled_star1_test[,1]
...
train_matrix_star1_test <- build_matrix(x_train_star1_test, n_timesteps + n_predictions)
...
history <- model %>% fit(x = list(X_train_date, X_train_boule1, X_train_boule2, X_train_boule3, X_train_boule4, X_train_star1, X_train_star1, X_train_star2),
                         y = list(y_train_date, y_train_boule1, y_train_boule2, y_train_boule3, y_train_boule4, y_train_star1, y_train_star1, y_train_star2),
                         epochs = epochs,
...
eval <- model %>% evaluate(list(X_test_date, X_test_boule1, X_test_boule2, X_test_boule3, X_test_boule4, X_test_star1, X_test_star1, X_test_star2), list(y_test_date, y_test_boule1, y_test_boule2, y_test_boule3, y_test_boule4, y_test_star1, y_test_star1, y_test_star2),verbose = 0)
message(eval)

pred_test <- model %>% predict(list(X_test_date, X_test_boule1, X_test_boule2, X_test_boule3, X_test_boule4, X_test_star1, X_test_star1, X_test_star2), verbose = 1, batch_size=batch_size)

#pred_test <- model %>% predict(list(y_test_date, y_test_boule1, y_test_boule2, y_test_boule3, y_test_boule4, y_test_star1, y_test_star1, y_test_star2), verbose = 1, batch_size=batch_size)
...
df$date <- sapply(df$date, function(x) format(as.Date(as.character(x), origin="1970-01-01"), "%Y-%m-%d"))
