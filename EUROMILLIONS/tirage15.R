...
trainY <- datas[2:(nrow(datas)-1), ]
train <- datas[1:(nrow(datas) -2), ]
test <- datas[(nrow(datas)-24):(nrow(datas)),]
testY <- datas[(nrow(datas)-37):(nrow(datas) - 13),]
row.names(train) <- seq(1:nrow(train))
row.names(test) <- seq(1:nrow(test))

date_train <- train$date
date_test <- test$date
date_train_Y <- trainY$date
date_test_Y <- testY$date
...
boule1_Y <- trainY$boule_1
boule2_Y <- trainY$boule_2
boule3_Y <- trainY$boule_3
boule4_Y <- trainY$boule_4
boule5_Y <- trainY$boule_5
...
boule1_test_Y <- testY$boule_1
boule2_test_Y <- testY$boule_2
boule3_test_Y <- testY$boule_3
boule4_test_Y <- testY$boule_4
boule5_test_Y <- testY$boule_5

star1 <- train$etoile_1
star2 <- train$etoile_2

star1_Y <- trainY$etoile_1
star2_Y <- trainY$etoile_2

star1_test <- test$etoile_1
star2_test <- test$etoile_2

star1_test_Y <- testY$etoile_1
star2_test_Y <- testY$etoile_2
...
ScaledDate_Y <- scale_date(as.data.frame(date_train_Y), as.data.frame(date_test_Y), c(0,1))
x_train_date_Y <- ScaledDate_Y$scaled_train[,1]
x_test_date_Y <- ScaledDate_Y$scaled_test[,1]
...
ScaledBoule_Y <- scale_boules(as.data.frame(boule1_Y), 
                            as.data.frame(boule2_Y),
                            as.data.frame(boule3_Y),
                            as.data.frame(boule4_Y),
                            as.data.frame(boule5_Y), 
                            as.data.frame(boule1_test_Y), 
                            as.data.frame(boule2_test_Y),
                            as.data.frame(boule3_test_Y),
                            as.data.frame(boule4_test_Y),
                            as.data.frame(boule5_test_Y),
                            c(0,1))
...
x_train_boule1_Y <- ScaledBoule_Y$scaled_boule1[,1]
x_train_boule2_Y <- ScaledBoule_Y$scaled_boule2[,1]
x_train_boule3_Y <- ScaledBoule_Y$scaled_boule3[,1]
x_train_boule4_Y <- ScaledBoule_Y$scaled_boule4[,1]
x_train_boule5_Y <- ScaledBoule_Y$scaled_boule5[,1]

x_train_boule1_test_Y <- ScaledBoule_Y$scaled_boule1_test[,1]
x_train_boule2_test_Y <- ScaledBoule_Y$scaled_boule2_test[,1]
x_train_boule3_test_Y <- ScaledBoule_Y$scaled_boule3_test[,1]
x_train_boule4_test_Y <- ScaledBoule_Y$scaled_boule4_test[,1]
x_train_boule5_test_Y <- ScaledBoule_Y$scaled_boule5_test[,1]
...
ScaledStar_Y <- scale_star(as.data.frame(star1_Y), 
                         as.data.frame(star2_Y),
                         as.data.frame(star1_test_Y),
                         as.data.frame(star2_test_Y),
                         c(0,1))
...
x_train_star1_Y <- ScaledStar_Y$scaled_star1[,1]
x_train_star2_Y <- ScaledStar_Y$scaled_star2[,1]

x_test_star1_Y <- ScaledStar_Y$scaled_star1_test[,1]
x_test_star2_Y <- ScaledStar_Y$scaled_star2_test[,1]
...
train_matrix_date_Y <- build_matrix(x_train_date_Y, n_timesteps + n_predictions)
test_matrix_date_Y <- build_matrix(x_test_date_Y, n_timesteps + n_predictions)
...
train_matrix_boule1_Y <- build_matrix(x_train_boule1_Y, n_timesteps + n_predictions)
train_matrix_boule2_Y <- build_matrix(x_train_boule2_Y, n_timesteps + n_predictions)
train_matrix_boule3_Y <- build_matrix(x_train_boule3_Y, n_timesteps + n_predictions)
train_matrix_boule4_Y <- build_matrix(x_train_boule4_Y, n_timesteps + n_predictions)
train_matrix_boule5_Y <- build_matrix(x_train_boule5_Y, n_timesteps + n_predictions)
...
train_matrix_boule1_test_Y <- build_matrix(x_train_boule1_test_Y, n_timesteps + n_predictions)
train_matrix_boule2_test_Y <- build_matrix(x_train_boule2_test_Y, n_timesteps + n_predictions)
train_matrix_boule3_test_Y <- build_matrix(x_train_boule3_test_Y, n_timesteps + n_predictions)
train_matrix_boule4_test_Y <- build_matrix(x_train_boule4_test_Y, n_timesteps + n_predictions)
train_matrix_boule5_test_Y <- build_matrix(x_train_boule5_test_Y, n_timesteps + n_predictions)
...
train_matrix_star1_Y <- build_matrix(x_train_star1_Y, n_timesteps + n_predictions)
train_matrix_star2_Y <- build_matrix(x_train_star2_Y, n_timesteps + n_predictions)
...
train_matrix_star1_test_Y <- build_matrix(x_test_star1_Y, n_timesteps + n_predictions)
train_matrix_star2_test_Y <- build_matrix(x_test_star2_Y, n_timesteps + n_predictions)

X_train_date <- train_matrix_date[, 1:(n_timesteps)]
y_train_date <- train_matrix_date_Y[, (n_timesteps +1):((n_timesteps * 2))]
X_test_date <- test_matrix_date[, 1:(n_timesteps)]
y_test_date <- test_matrix_date_Y[, (n_timesteps +1):((n_timesteps * 2))]


X_train_boule1 <- train_matrix_boule1[, 1:(n_timesteps)]
y_train_boule1 <- train_matrix_boule1_Y[, 1:(n_timesteps)]
X_test_boule1 <- train_matrix_boule1_test[, 1:(n_timesteps)]
y_test_boule1 <- train_matrix_boule1_test_Y[, 1:(n_timesteps)]


X_train_boule2 <- train_matrix_boule2[, 1:(n_timesteps)]
y_train_boule2 <- train_matrix_boule2_Y[, 1:(n_timesteps)]
X_test_boule2 <- train_matrix_boule2_test[, 1:(n_timesteps)]
y_test_boule2 <- train_matrix_boule2_test_Y[, 1:(n_timesteps)]


X_train_boule3 <- train_matrix_boule3[, 1:(n_timesteps)]
y_train_boule3 <- train_matrix_boule3_Y[, 1:(n_timesteps)]
X_test_boule3 <- train_matrix_boule3_test[, 1:(n_timesteps)]
y_test_boule3 <- train_matrix_boule3_test_Y[, 1:(n_timesteps)]

X_train_boule4 <- train_matrix_boule4[, 1:(n_timesteps)]
y_train_boule4 <- train_matrix_boule4_Y[, 1:(n_timesteps)]
X_test_boule4 <- train_matrix_boule4_test[, 1:(n_timesteps)]
y_test_boule4 <- train_matrix_boule4_test_Y[, 1:(n_timesteps)]



X_train_boule5 <- train_matrix_boule5[, 1:(n_timesteps)]
y_train_boule5 <- train_matrix_boule5_Y[, 1:(n_timesteps)]
X_test_boule5 <- train_matrix_boule5_test[, 1:(n_timesteps)]
y_test_boule5 <- train_matrix_boule5_test_Y[, 1:(n_timesteps)]



X_train_star1 <- train_matrix_star1[, 1:(n_timesteps)]
y_train_star1 <- train_matrix_star1_Y[, 1:(n_timesteps)]
X_test_star1 <- train_matrix_star1_test[, 1:(n_timesteps)]
y_test_star1 <- train_matrix_star1_test_Y[, 1:(n_timesteps)]



X_train_star2 <- train_matrix_star2[, 1:(n_timesteps)]
y_train_star2 <- train_matrix_star2_Y[, 1:(n_timesteps)]
X_test_star2 <- train_matrix_star2_test[, 1:(n_timesteps)]
y_test_star2 <- train_matrix_star2_test_Y[, 1:(n_timesteps)]
...
outputLSTM_boule1 <- inputsLSTM_boule1  %>%
  layer_lstm (units = 100, name='lstm_0_boule1', input_shape = c(n_timesteps, n_features)) %>% 
...
outputLSTM_boule2 <- inputsLSTM_boule2  %>%
  layer_lstm (units = 100, name='lstm_0_boule2', input_shape = c(n_timesteps, n_features)) %>% 
...
outputLSTM_boule3 <- inputsLSTM_boule3  %>%
  layer_lstm (units = 100, name='lstm_0_boule3', input_shape = c(n_timesteps, n_features)) %>% 
...
outputLSTM_boule4 <- inputsLSTM_boule4  %>%
  layer_lstm (units = 100, name='lstm_0_boule4',  input_shape = c(n_timesteps, n_features)) %>% 
...
outputLSTM_boule5 <- inputsLSTM_boule5  %>%
  layer_lstm (units = 100, name='lstm_0_boule5',  input_shape = c(n_timesteps, n_features)) %>% 
...
outputLSTM_star1 <- inputsLSTM_star1  %>%
  layer_lstm (units = 100, name='lstm_0_star1',  input_shape = c(n_timesteps, n_features)) %>% 
...
outputLSTM_star2 <- inputsLSTM_star2  %>%
  layer_lstm (units = 100, name='lstm_0_star2', input_shape = c(n_timesteps, n_features)) %>% 
...
output_date  <- inputs_date %>%
  layer_dense(units = 100, name='close_dense_0') %>% 
...
combined_boule1 <- layer_concatenate(c(outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5), name='concatenate_boule1') %>%
  layer_dense(units = 100, name='combined_dense_boule1') %>%
...
combined_boule2 <- layer_concatenate(c(outputLSTM_boule2, outputLSTM_boule1, outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5), name='concatenate_boule2') %>%
  layer_dense(units = 100, name='combined_dense_boule2') %>%
...
combined_boule3 <- layer_concatenate(c(outputLSTM_boule3, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule4, outputLSTM_boule5), name='concatenate_boule3') %>%
  layer_dense(units = 100, name='combined_dense_boule3') %>%
...
combined_boule4 <- layer_concatenate(c(outputLSTM_boule4, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule5), name='concatenate_boule4') %>%
  layer_dense(units = 100, name='combined_dense_boule4') %>%
...
combined_boule5 <- layer_concatenate(c(outputLSTM_boule5, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4), name='concatenate_boule5') %>%
  layer_dense(units = 100, name='combined_dense__boule5') %>%
...
combined_star1 <- layer_concatenate(c(outputLSTM_star1, outputLSTM_star2), name='concatenate_star1') %>%
  layer_dense(units = 100, name='combined_dense_star1') %>%
...
combined_star2 <- layer_concatenate(c(outputLSTM_star2, outputLSTM_star1), name='concatenate_star2') %>%
  layer_dense(units = 100, name='combined_dense__star2') %>%
...
date_predict <- unlist(reverse_scaling(as.data.frame(pred_test[1]), ScaledDate_Y$scaler))
boule1 <- unlist(reverse_scaling(as.data.frame(pred_test[2]), ScaledBoule_Y$scaler))
boule2 <- unlist(reverse_scaling(as.data.frame(pred_test[3]), ScaledBoule_Y$scaler))
boule3 <- unlist(reverse_scaling(as.data.frame(pred_test[4]), ScaledBoule_Y$scaler))
boule4 <- unlist(reverse_scaling(as.data.frame(pred_test[5]), ScaledBoule_Y$scaler))
boule5 <- unlist(reverse_scaling(as.data.frame(pred_test[6]), ScaledBoule_Y$scaler))
star1 <- unlist(reverse_scaling(as.data.frame(pred_test[7]), ScaledStar_Y$scaler))
star2 <- unlist(reverse_scaling(as.data.frame(pred_test[8]), ScaledStar_Y$scaler))
