...
test <- datas[(nrow(datas)-79):nrow(datas),]
...
X_train_date <- train_matrix_date[, (n_timesteps + 1):(n_timesteps + n_predictions)]
y_train_date <- train_matrix_date[, 1:n_timesteps]
X_test_date <- test_matrix_date[, (n_timesteps + 1):(n_timesteps + n_predictions)]
...
X_train_boule1 <- train_matrix_boule1[, (n_timesteps + 1):(n_timesteps + n_predictions)]
y_train_boule1 <- train_matrix_boule1[, 1:n_timesteps]
X_test_boule1 <- train_matrix_boule1_test[, (n_timesteps + 1):(n_timesteps + n_predictions)]
...
X_train_boule2 <- train_matrix_boule2[, (n_timesteps + 1):(n_timesteps + n_predictions)]
y_train_boule2 <- train_matrix_boule2[, 1:n_timesteps]
X_test_boule2 <- train_matrix_boule2_test[, (n_timesteps + 1):(n_timesteps + n_predictions)]
...
X_train_boule3 <- train_matrix_boule3[, (n_timesteps + 1):(n_timesteps + n_predictions)]
y_train_boule3 <- train_matrix_boule3[, 1:n_timesteps]
X_test_boule3 <- train_matrix_boule3_test[, (n_timesteps + 1):(n_timesteps + n_predictions)]
...
X_train_boule4 <- train_matrix_boule4[, (n_timesteps + 1):(n_timesteps + n_predictions)]
y_train_boule4 <- train_matrix_boule4[, 1:n_timesteps]
X_test_boule4 <- train_matrix_boule4_test[, (n_timesteps + 1):(n_timesteps + n_predictions)]
...
X_train_boule5 <- train_matrix_boule5[, (n_timesteps + 1):(n_timesteps + n_predictions)]
y_train_boule5 <- train_matrix_boule5[, 1:n_timesteps]
X_test_boule5 <- train_matrix_boule5_test[, (n_timesteps + 1):(n_timesteps + n_predictions)]
...
X_train_star1 <- train_matrix_star1[, (n_timesteps + 1):(n_timesteps + n_predictions)]
y_train_star1 <- train_matrix_star1[, 1:n_timesteps]
X_test_star1 <- train_matrix_star1_test[, (n_timesteps + 1):(n_timesteps + n_predictions)]
...
X_train_star2 <- train_matrix_star2[, (n_timesteps + 1):(n_timesteps + n_predictions)]
y_train_star2 <- train_matrix_star2[, 1:n_timesteps]
X_test_star2 <- train_matrix_star2_test[, (n_timesteps + 1):(n_timesteps + n_predictions)]
...
FLAGS <- tfruns::flags(
  ...
  flag_integer("batch_size", 1), # number of samples fed to model in one go
  flag_integer("n_timesteps", 34), #size of the hidden state, equals size of predictions
...
message(">> Training")
#model <- load_model_hdf5('tirage43.h5',  compile = TRUE)
...
#pred_test <- model %>% predict(list(y_test_date,y_test_boule1, y_test_boule2, y_test_boule3, y_test_boule4, y_test_boule5, y_test_star1, y_test_star2), verbose = 1, batch_size=batch_size)
  ...
  #pred_test <- model %>% predict(list(y_train_date, y_train_boule1, y_train_boule2, y_train_boule3, y_train_boule4, y_train_boule5, y_train_star1, y_train_star2), verbose = 1, batch_size=batch_size)
    ...
    pred_test <- model %>% predict(list(X_train_date, X_train_boule1, X_train_boule2, X_train_boule3, X_train_boule4, X_train_boule5, X_train_star1, X_train_star2), verbose = 1, batch_size=1)
