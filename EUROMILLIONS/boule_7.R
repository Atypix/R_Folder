...
boule = as.data.frame(df$etoile_2)
names(boule)[names(boule) == "etoile_2"] <- "boule"
...
model <- load_model_hdf5('boule_7.h5', custom_objects = NULL, compile = TRUE)
...
names(pred)[1]<-paste("df$etoile_2")
