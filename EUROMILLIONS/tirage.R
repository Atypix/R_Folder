...
df$date <- sapply(df$date, function(x) as.numeric(as.Date(x)))

df$boule_1 <- sapply(df$boule_1, function(x) as.numeric(x))
df$boule_2 <- sapply(df$boule_2, function(x) as.numeric(x))
df$boule_3 <- sapply(df$boule_3, function(x) as.numeric(x))
df$boule_4 <- sapply(df$boule_4, function(x) as.numeric(x))
df$boule_5 <- sapply(df$boule_5, function(x) as.numeric(x))

df$etoile_1 <- sapply(df$etoile_1, function(x) as.numeric(x))
df$etoile_2 <- sapply(df$etoile_2, function(x) as.numeric(x))
...
output_date  <- inputs_date %>%
  layer_dense(units = 5, name='close_dense_0') %>% 
...
combined_boule1 <- layer_concatenate(c(outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5), name='concatenate_boule1') %>%
  layer_dense(units = 1004, name='combined_dense_boule1') %>%
...
combined_boule2 <- layer_concatenate(c(outputLSTM_boule2, outputLSTM_boule1, outputLSTM_boule3, outputLSTM_boule4, outputLSTM_boule5), name='concatenate_boule2') %>%
  layer_dense(units = 1004, name='combined_dense_boule2') %>%
...
combined_boule3 <- layer_concatenate(c(outputLSTM_boule3, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule4, outputLSTM_boule5), name='concatenate_boule3') %>%
  layer_dense(units = 1004, name='combined_dense_boule3') %>%
...
combined_boule4 <- layer_concatenate(c(outputLSTM_boule4, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule5), name='concatenate_boule4') %>%
  layer_dense(units = 1004, name='combined_dense_boule4') %>%
...
combined_boule5 <- layer_concatenate(c(outputLSTM_boule5, outputLSTM_boule1, outputLSTM_boule2, outputLSTM_boule3, outputLSTM_boule4), name='concatenate_boule5') %>%
  layer_dense(units = 1004, name='combined_dense__boule5') %>%
...
combined_star1 <- layer_concatenate(c(outputLSTM_star1, outputLSTM_star2), name='concatenate_star1') %>%
  layer_dense(units = 1004, name='combined_dense_star1') %>%
...
combined_star2 <- layer_concatenate(c(outputLSTM_star2, outputLSTM_star1), name='concatenate_star2') %>%
  layer_dense(units = 1004, name='combined_dense__star2') %>%
...
eval <- model %>% evaluate(list(X_test_date, X_test_boule1, X_test_boule2, X_test_boule3, X_test_boule4, X_test_boule5, X_test_star1, X_test_star2), list(y_test_date, y_test_boule1, y_test_boule2, y_test_boule3, y_test_boule4, y_test_boule5, y_test_star1, y_test_star2),verbose = 0)
message(eval)
...
view_test$date <- sapply(view_test$date, function(x) format(as.Date(x, origin="1970-01-01"), "%Y-%m-%d"))
df$date <- sapply(df$date, function(x) format(as.Date(x, origin="1970-01-01"), "%Y-%m-%d"))

dplr <- left_join(df, view_test, by=c("date"))
dfGraph <- na.omit(dplr)

b <- ggplot(dfGraph, aes(x=as.Date(date)))
b <- b + geom_line(aes(y = boule_1))
b <- b + geom_line(aes(y = boule_1_test), color = "red")

print(b)


b <- ggplot(dfGraph, aes(x=as.Date(date)))
b <- b + geom_line(aes(y = boule_5))
b <- b + geom_line(aes(y = boule_5_test), color = "red")
print(b)